...
from .views import (tag_list, tag_detail, startup_list, startup_detail, TagCreate, 
	StartupCreate, NewsLinkCreate, NewsLinkUpdate, TagUpdate, StartupUpdate,
	NewsLinkDelete, TagDelete, StartupDelete)

urlpatterns = [
	url(r'^newslink/create$', NewsLinkCreate.as_view(), name='organizer_newslink_create'),
	url(r'^newslink/delete$', NewsLinkDelete.as_view(), name='organizer_newslink_delete'),
	url(r'^newslink/update$', NewsLinkUpdate.as_view(), name='organizer_newslink_update'),
